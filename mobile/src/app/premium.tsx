  ...
  const plans: Plan[] = [
    {
      ...
      icon: Sparkles,
      features: [
        { text: '2 scans par mois', included: true },
    ...
    },
    {
      id: 'family',
      name: 'Famille',
      tagline: 'Tranquillité pour toute la famille',
      monthlyPrice: 14.99,
      annualPrice: 99.99,
      annualSavings: '44% d\'économie',
      entitlement: 'family',
      color: '#059669',
      ...
      features: [
        ...
        { text: 'Alertes aidants en temps réel', included: true, highlight: true },
        { text: 'Réponses auto aux courriers', included: true, highlight: true },
        { text: 'Rappels d\'échéances intelligents', included: true, highlight: true },
        { text: 'Export & impression PDF', included: true },
        { text: 'Alerte inactivité senior', included: true },
